...
class TrainingMode(object):
    ...
    @staticmethod
    def execute_training(path_to_training_files, minimal_article_length, path_to_premise_file, path_to_conjunction_file, path_to_paratax_file, path_to_hypotax_file,
                         indicator_threshold
        ...
        VectorCalculator.VectorCalculator.update_vectors_in_corpus(articles, path_to_premise_file,
                                                                   path_to_conjunction_file, path_to_paratax_file,
                                                                   path_to_hypotax_file, indicator_threshold)
...
TrainingMode.execute_training(
    '/Users/christophmaier/Documents/Uni Passau/Text Mining Project/files/Spiegel-Corpus Modified', 500,
    ...
    "/Users/christophmaier/PycharmProjects/PolArg/hypotax_file.txt", 2, "VectorFile", "generic")
