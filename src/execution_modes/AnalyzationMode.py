...
class AnalyzationMode(object):
    ...
    @staticmethod
    def execute(path_to_analyzation_files, minimal_article_length, path_to_stopword_file, path_to_indicator_file, path_to_training_file_one,
        ...
        corpus = VectorCalculator.VectorCalculator.update_vectors_in_corpus(corpus,
